...
export default function QRCard({ qr, onClick }: QRCardProps) {
  ...
  // 🔥 FIX 2: Smart Content Display
  // Hides raw URLs for non-URL types
  const getDisplayContent = () => {
    switch (qr.qr_type) {
      ...
      default:
        return qr.target_url || "Scannable Content";
    }
  };
    ...
    >
      ...
      <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-100">
        <div className="flex items-center gap-1.5 text-xs text-gray-500">
            ...
            <span className="font-medium text-gray-900">{qr.scan_count || 0}</span> <span className="text-gray-400">Scans</span>
        </div>
