    ...
    <div className="p-4 md:p-8 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        {projects.map((project) => (
          <div
            key={project.id}
            onClick={() => router.push(`/dashboard/projects/${project.id}`)} // Navigate
            className="bg-white border hover:border-blue-300 hover:shadow-md transition-all rounded-xl p-5 cursor-pointer group active:scale-95 sm:active:scale-100"
          >
